@extends("layouts.base")
    ...
    <section class="chooseus-section alternet-2">
        <div class="auto-container">
            <div class="sec-title centered">
                <h3>Borno State Sharia Court of Appeal</h3>
                <div class="text">
								...
								<div class="two-column">
									<div class="row clearfix">
										...
										<div class="column col-lg-8 col-md-8 col-sm-12">
											...
											<p class="text-justify">The Borno State Sharia Court of Appeal is an appalent court. Sharia Court of Appeal is a Superior Court of Record established
    ...
    <section class="team-section pt-2">
		<div class="auto-container">
			<!-- Sec Title -->
			<div class="sec-title centered">
				<h2>Sharia Court of Appeal Judges</h2>
			</div>
			<div class="row clearfix">
