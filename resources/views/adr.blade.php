@extends("layouts.base")
    ...
    <section class="page-title" style="background-image:url(assets/images/background/1.jpg)">
    	<div class="auto-container">
			<h1> Alternative Dispute Resolution Unit</h1>
    ...
    <section class="chooseus-section alternet-2">
        <div class="auto-container">
            <div class="sec-title centered">
                <h3>Amicable Settlement Corridor</h3>
                <div class="text">
								...
								<div class="two-column">
									<div class="row clearfix">
										...
										<div class="column col-lg-8 col-md-8 col-sm-12">
											...
											<p class="text-justify">The Amicable Settlement Corridor adopted four approach in resolving disputes, 
                                                these are;
                                        ...
                                        <div class="column col-lg-4 col-md-4 col-sm-12">
											...
											<div class="image">
												<img src="assets/images/resource/adr.jpg" alt="" />
											</div>
                                        </div>
										</div>
									</div>
