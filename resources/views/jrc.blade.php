@extends("layouts.base")
    ...
    <section class="page-title" style="background-image:url(assets/images/background/1.jpg)">
    	<div class="auto-container">
			<h1> Judicial Research Centre</h1>
			<ul class="page-breadcrumb">
				<li><a href="index.html">home</a></li>
				<li>Liberty Centre </li>
			</ul>
        </div>
    </section>
    <!-- End Page Title -->
    <section class="chooseus-section alternet-2">
        <div class="auto-container">
            <div class="sec-title centered">
                <h3>Shettima Liberty Judicial Research Centre</h3>
                <div class="text">
            ...
            <p class="text-justify">
                The Judicial Research Centre (JRC) is a robust ICT infrastructure providing 
